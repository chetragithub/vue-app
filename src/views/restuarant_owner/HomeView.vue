    ...
    <v-main class="grid-container mx-2 mt-2 gap-2">
      ...
      >
        ...
        <div class="w-50 d-flex justify-center">
          <h5 v-if="products.length > 1" class="mt-2">
            {{ products.length }} {{ $t("app.items") }}
          </h5>
          <h5 v-else class="mt-2">
            {{ products.length }} {{ $t("app.item") }}
          </h5>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div class="w-50 d-flex justify-center">
          <h5 v-if="categories.length > 1" class="mt-2">
            {{ categories.length }} {{ $t("app.items") }}
          </h5>
          <h5 v-else class="mt-2">
            {{ categories.length }} {{ $t("app.item") }}
          </h5>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div class="w-50 d-flex justify-center">
          <h5 v-if="tables.length > 1" class="mt-2">
            {{ tables.length }} {{ $t("app.items") }}
          </h5>
      ...
      >
        ...
        <div class="w-50 d-flex justify-center">
          <h5 v-if="staff.length > 1" class="mt-2">
            {{ staff.length }} {{ $t("app.crud.staff.people") }}
          </h5>
          <h5 v-else class="mt-2">
            {{ staff.length }} {{ $t("app.crud.staff.person") }}
          </h5>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div class="w-50 d-flex justify-center">
          <h5 v-if="totalProduct > 1" class="mt-2">
            {{ totalProduct }} {{ $t("app.items") }}
          </h5>
      ...
      >
        ...
        <div class="w-50 d-flex justify-center">
          <h5 class="mt-2">
            {{ $t("app.currency") }}{{ totalMoney.toFixed(2) }}
          </h5>
        </div>
      </div>
    </v-main>
